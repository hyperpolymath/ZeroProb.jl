...
**Files:**
- `/var$REPOS_DIR/ZeroProb.jl/.gitignore` (line 1: `# SPDX-License-Identifier: PMPL-1.0-or-later`)
- `/var$REPOS_DIR/ZeroProb.jl/.gitattributes` (line 1: `# SPDX-License-Identifier: PMPL-1.0-or-later`)
- `/var$REPOS_DIR/ZeroProb.jl/ffi/zig/build.zig` (line 2: `// SPDX-License-Identifier: PMPL-1.0-or-later`)
- `/var$REPOS_DIR/ZeroProb.jl/ffi/zig/src/main.zig` (line 6: `// SPDX-License-Identifier: PMPL-1.0-or-later`)
- `/var$REPOS_DIR/ZeroProb.jl/ffi/zig/test/integration_test.zig` (line 2: `// SPDX-License-Identifier: PMPL-1.0-or-later`)
- `/var$REPOS_DIR/ZeroProb.jl/docs/CITATIONS.adoc` (line 13: `license = {PMPL-1.0-or-later}`)
