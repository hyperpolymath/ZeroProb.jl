...
git clone https://github.com/hyperpolymath/ZeroProb.jl.git cd
ZeroProb.jl
...
toolbox create ZeroProb.jl-dev toolbox enter ZeroProb.jl-dev # Install
...
ZeroProb.jl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
