...
doctor:
    @echo "Running diagnostics for ZeroProb.jl..."
...
help-me:
    @echo "=== ZeroProb.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/ZeroProb.jl/issues/new"
    @echo ""
